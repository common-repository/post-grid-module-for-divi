...
trait Field_Compatibility {
	 ...
	 * @return array
	 */
	protected function squad_fix_border_transition( &$fields, $slug, $selector ) {
		// all.
	 ...
	 * @return array $fields
	 */
	protected function squad_fix_fonts_transition( &$fields, $slug, $selector ) {
	 ...
	 * @return array
	 */
	protected function squad_fix_box_shadow_transition( &$fields, $slug, $selector ) {
